...
flags.DEFINE_string(
    ...
    "The input source_json_dir. Should contain the .tsv files (or other data files) "
    "for the task.")
...
class Snips_Slot_Filling_and_Intent_Detection_Processor(DataProcessor):
    ...
    def get_slot_labels(self):
        # with open(FLAGS.source_json_dir, "r", encoding='utf-8') as fp:
        #     json_data = json.load(fp)
        # slots = ['[Padding]', '[##WordPiece]', '[CLS]', '[SEP]']
        #
        # for i in json_data:
        #     for j in i["seq_outs"]:
        #         slots.append(j)
    ...
    def get_intent_labels(self):
        ...
        #
        # for i in json_data:
        #     intent_labels.append(i["labels"])
        # labels_set = set(intent_labels)
        #
